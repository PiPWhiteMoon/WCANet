...
model = WCANet()
model.load_pre('D:/PaperCode/RES34_1_best_mae_test.pth')
model.cuda()
...
train_loader = get_loader(image_root, gt_root, depth_root, bound_root, gt2_root, batchsize=opt.batchsize,
...
best_mae = 1
best_epoch = 0
Sacler = amp.GradScaler(init_scale=2**16, growth_factor=2.0, backoff_factor=0.5, growth_interval=2000)
